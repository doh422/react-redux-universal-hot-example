...
export default class About extends Component {
  ...
  componentDidMount() {
    ...
    if (user.results.complete) {
      Traitify.ui.load('results', user.test_id, '.result-deck');
      Traitify.ui.load('personalityTypes', user.test_id, '.personality-types');
      Traitify.ui.load('personalityTraits', user.test_id, '.personality-traits');
    }
  }
  ...
  componentDidUpdate(prevProps) {
    ...
    // show results
      const showResults = Traitify.ui.load('results', user.test_id, '.result-deck');
      Traitify.ui.load('personalityTypes', user.test_id, '.personality-types');
      Traitify.ui.load('personalityTraits', user.test_id, '.personality-traits');
